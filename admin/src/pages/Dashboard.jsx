            ...
            <div className="flex justify-between items-center shrink-0">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-xl text-xs font-medium text-gray-600 hover:bg-[#F8F9FC] hover:border-[#0A3D62]/20 transition-colors"
                    >
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-white rounded-xl text-xs font-medium transition-all"
                        style={{ background: 'linear-gradient(135deg, #0A3D62 0%, #1E6F9F 100%)' }}
                    >
