...
const GlobalInvestmentGateway = () => {
    ...
    // Prioritize 'introduction' if present (from admin edits), otherwise use 'executiveOverview'
    const introductoryText = content.introduction || content.executiveOverview || defaultContent.executiveOverview;
    const dynamicOverview = introductoryText.replace('Instrak Venture Capital Berhad', siteName);
