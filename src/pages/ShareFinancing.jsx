...
import { BarChart3, Shield, Globe, Users, Target, CheckCircle } from 'lucide-react';
...
const ShareFinancing = () => {
    ...
    const defaultData = {
        ...
        introduction: 'Strategic share financing solutions for shareholders and institutional investors. Unlock liquidity from your equity holdings through our structured share financing solutions, designed for scalability and capital efficiency.',
        overview: {
            heading: 'Strategic Share Financing',
            description: 'Unlock liquidity from your equity holdings through our structured share financing solutions.'
        },
        services: [
            { icon: <BarChart3 />, title: 'Stock Loans', desc: 'Secure financing using publicly traded shares as collateral.' },
            { icon: <Shield />, title: 'Asset Protection', desc: 'Maintain market exposure while accessing immediate capital.' },
            { icon: <Globe />, title: 'Global Markets', desc: 'Support for multiple major stock exchanges worldwide.' },
            { icon: <Users />, title: 'Institutional Terms', desc: 'Tailored solutions for major shareholders and institutions.' },
        ]
    };
