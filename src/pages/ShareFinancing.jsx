                ...
                <div className="container">
                    <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
                         <p style={{ fontSize: '1.15rem', color: '#4A5568', lineHeight: '1.9' }}>
                            Strategic share financing solutions for shareholders and institutional investors.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', color: '#4A5568', lineHeight: '1.8', marginBottom: '2rem' }}>
                            Service details available upon request. Contact our team to learn more about our Share Financing (SF) solutions.
                        </p>
