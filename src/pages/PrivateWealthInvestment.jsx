...
import { Gem, Landmark, ShieldCheck, Globe, TrendingUp, CheckCircle } from 'lucide-react';
...
const PrivateWealthInvestment = () => {
    ...
    const defaultData = {
        title: 'PRIVATE WEALTH INVESTMENT',
        subtitle: 'The Luxury Dubai — Exclusive private wealth investment opportunities in premium real estate.',
        introduction: 'The Luxury Dubai — Exclusive private wealth investment opportunities in premium real estate. Access Dubai\'s most prestigious real estate and private wealth opportunities through our specialized investment structures, tailored for discerning global investors.',
        overview: {
            heading: 'The Luxury Dubai Investments',
            description: 'Exclusive access to Dubai\'s most prestigious real estate and private wealth opportunities.'
        },
        services: [
            { icon: <Landmark />, title: 'Premium Real Estate', desc: 'Secure high-value residential and commercial properties in Dubai\'s most sought-after locations.' },
            { icon: <Gem />, title: 'Luxury Portfolios', desc: 'Curated investment portfolios featuring exclusive luxury assets and developments.' },
            { icon: <ShieldCheck />, title: 'Wealth Preservation', desc: 'Structured investment vehicles designed to protect and grow your private wealth.' },
            { icon: <Globe />, title: 'Global Connectivity', desc: 'Seamlessly integrate Dubai real estate into your broader international investment strategy.' },
        ]
    };
                ...
                <div className="container">
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <div style={{ background: '#FFFFFF', padding: '2.5rem', borderRadius: '12px', border: '1px solid rgba(26, 54, 93, 0.1)', boxShadow: '0 4px 20px rgba(26, 54, 93, 0.08)' }}>
                            <ProtectedFormSection serviceName="The Luxury Dubai">
                                <DynamicServiceForm
                                    serviceId="private-wealth"
                                    title="Inquire About Dubai Investments"
                                />
